...
local function Load(Path, Name)
    ...
    if IsStudio then
        ...
        local Function = shared.TidalWaveDev and loadfile(`TidalWave/{Path}`) or loadstring(game:HttpGet(`https://github.com/fluidnarrator30/Tidal-Wave/blob/main/{Path}.lua`), Name)
